...
public class TestCase_IOT_Instance_Val_Confidence {
     ...
     *
     */
    private static void testSinkValidated( String[] ignored_args)
    {
        try {
     ...
     *
     */
    private static void testSinkValidationNotUsed( String[] ignored_args)
    {
        try {
            TestCase_IOT_Instance_Val_Confidence testCase = new TestCase_IOT_Instance_Val_Confidence();
            String file = "SomeFile";
     ...
     *
     */
    private static void testSinkNoValidationAvailable( String[] ignored_args)
    {
        try {
            TestCase_IOT_Instance_Val_Confidence testCase = new TestCase_IOT_Instance_Val_Confidence();
            String file = "SomeFile";
     ...
     *
     */
    private static void testLostValidated( String[] ignored_args)
    {
        try {
            TestCase_IOT_Instance_Val_Confidence testCase = new TestCase_IOT_Instance_Val_Confidence();
            String file = "SomeFile";
     ...
     *
     */
    private static void testLostValidationNotUsed( String[] ignored_args)
    {
        try {
            TestCase_IOT_Instance_Val_Confidence testCase = new TestCase_IOT_Instance_Val_Confidence();
            String file = "SomeFile";
     ...
     *
     */
    private static void testLostNoValidationAvailable( String[] ignored_args)
    {
        try {
            TestCase_IOT_Instance_Val_Confidence testCase = new TestCase_IOT_Instance_Val_Confidence();
            String file = "SomeFile";
